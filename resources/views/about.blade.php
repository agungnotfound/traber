                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @if (Route::has('login'))
                            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                                ...
                                <a href="{{ route('home') }}" class="ml-4 text-gray-700 dark:text-gray-500">Beranda</a>
                                
                                <a href="{{ route('about') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500">Tentang Kami</a>

                                <a href="{{ route('tracking') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500">Tracking Berkas</a>
                                @auth
                                    <a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500">Home</a>
                                @else
                                    <a href="{{ route('login') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500">Login</a>
                                @endauth
                            </div>
                        @endif
                    </ul>
