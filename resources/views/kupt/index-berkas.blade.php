            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{route('kupt.wajib-pajak.create')}}" class="btn btn-primary">Tambah Berkas</a>
                        </div>
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->status}}</td>
                                    <td>
                                        <a href="{{route('kupt.wajib-pajak.edit', $row->no_pelayanan)}}" title="Edit"><i class="fa fa-pencil-alt"></i></a>
                                        ...
                                        <a href="#" data-href="{{route('kupt.wajib-pajak.destroy', $row->no_pelayanan)}}" class="openConfirm" title="Delete"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteUserLabel">Konfirmasi Hapus Berkas</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Apakah Anda Yakin menghapus Berkas ini?
            </div>
...
<div class="modal fade" id="updateStatus" tabindex="-1" role="dialog" aria-labelledby="deleteUserLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('kupt.wajib-pajak.update')}}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
