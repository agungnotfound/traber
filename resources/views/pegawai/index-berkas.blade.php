            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{route('pegawai.wajib-pajak.create')}}" class="btn btn-primary">Tambah Berkas</a>
                        </div>
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->status}}</td>
                                    <td>
                                        <a href="{{route('pegawai.wajib-pajak.edit', $row->no_pelayanan)}}" title="Edit"><i class="fa fa-pencil-alt"></i></a>
                                        ...
                                        <a href="#" data-href="{{route('pegawai.wajib-pajak.destroy', $row->no_pelayanan)}}" class="openConfirm" title="Delete"
...
<div class="modal fade" id="updateStatus" tabindex="-1" role="dialog" aria-labelledby="deleteUserLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('pegawai.wajib-pajak.update')}}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
